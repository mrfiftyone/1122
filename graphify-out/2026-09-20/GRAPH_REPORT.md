...
- `addComment()` --calls--> `containsProfanity()`  [EXTRACTED]
  src/app/page.tsx → src/utils/moderation.ts
...
Cohesion: 0.06
Nodes (46): AVATAR_COLORS, BookmarkItem, Comment, GOVERNORATES, GRADE_OPTIONS, GRADES, NotificationItem, Post (+38 more)

### Community 1 - "Home"
Cohesion: 0.07
Nodes (36): getNotifications(), getPosts(), getSession(), getTeachers(), getVotes(), Home(), addComment(), adminDeleteReportedItem() (+28 more)
...
- **Why does `Home()` connect `Home` to `app/page.tsx`, `toggleBookmark`, `normalizeTeacherName`, `handleAuth`?**
